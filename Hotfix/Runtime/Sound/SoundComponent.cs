...
namespace Hotfix.Runtime
{
   ...
   // [GfComponent]
    public sealed partial class SoundComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_SoundHelperTypeName = "Hotfix.Runtime.DefaultSoundHelper";

        [SerializeField]
        private SoundHelperBase m_CustomSoundHelper = null;

        [SerializeField]
        private string m_SoundGroupHelperTypeName = "Hotfix.Runtime.DefaultSoundGroupHelper";

        [SerializeField]
        private SoundGroupHelperBase m_CustomSoundGroupHelper = null;

        [SerializeField]
        private string m_SoundAgentHelperTypeName = "Hotfix.Runtime.DefaultSoundAgentHelper";
