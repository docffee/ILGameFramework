...
namespace Hotfix.Runtime
{
    ...
    public sealed partial class EntityComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_EntityHelperTypeName = "Hotfix.Runtime.DefaultEntityHelper";

        [SerializeField]
        private EntityHelperBase m_CustomEntityHelper = null;

        [SerializeField]
        private string m_EntityGroupHelperTypeName = "Hotfix.Runtime.DefaultEntityGroupHelper";
