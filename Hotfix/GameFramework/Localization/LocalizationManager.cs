    ...
    internal sealed class LocalizationManager : GameFrameworkModule, ILocalizationManager
    {
        ...
        public Language Language
        {
            ...
            set
            {
                ...
                {
                    throw new System.Exception("Language is invalid.");
                }
        ...
        public Language SystemLanguage
        {
            get
            {
                ...
                {
                    throw new System.Exception("You must set localization helper first.");
                }
        ...
        public void SetLocalizationHelper(ILocalizationHelper localizationHelper)
        {
            ...
            {
                throw new System.Exception("Localization helper is invalid.");
            }
        ...
        private void LoadDictionarySuccessCallback(string dictionaryAssetName, object dictionaryAsset, float duration, object userData)
        {
            try
            {
                ...
                {
                    throw new System.Exception(string.Format("Load dictionary failure in helper, asset name '{0}'.", dictionaryAssetName));
                }
            }
            catch (Exception exception)
            {
