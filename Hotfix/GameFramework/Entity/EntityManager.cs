...
namespace GameFramework.Entity
{
    ...
    internal sealed partial class EntityManager : GameFrameworkModule, IEntityManager
    {
        ...
        public void SetResourceManager(IResourceManager resourceManager)
        {
            ...
            {
                throw new System.Exception("Resource manager is invalid.");
            }
        ...
        public bool AddEntityGroup(string entityGroupName, float instanceAutoReleaseInterval, int instanceCapacity, float instanceExpireTime, int instancePriority, IEntityGroupHelper entityGroupHelper)
        {
            ...
            {
                throw new System.Exception("Entity group helper is invalid.");
            }

            if (m_ObjectPoolManager == null)
            {
                throw new System.Exception("You must set object pool manager first.");
            }
        ...
        public void HideEntity(int entityId, object userData)
        {
            ...
            if (entityInfo == null)
            {
                throw new System.Exception(string.Format("Can not find entity '{0}'.", entityId.ToString()));
            }
        ...
        public IEntity GetParentEntity(IEntity childEntity)
        {
            if (childEntity == null)
            {
                throw new System.Exception("Child entity is invalid.");
            }
        ...
        public IEntity[] GetChildEntities(IEntity parentEntity)
        {
            ...
            {
                throw new System.Exception("Parent entity is invalid.");
            }
        ...
        public void DetachEntity(int childEntityId, object userData)
        {
            ...
            if (parentEntityInfo == null)
            {
                throw new System.Exception(string.Format("Can not find parent entity '{0}'.", parentEntity.Id.ToString()));
            }
        ...
        private void InternalShowEntity(int entityId, string entityAssetName, EntityGroup entityGroup, object entityInstance, bool isNewInstance, float duration, object userData)
        {
            try
            {
                ...
                if (entity == null)
                {
                    throw new System.Exception("Can not create entity in helper.");
                }
