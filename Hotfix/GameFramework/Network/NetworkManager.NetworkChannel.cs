        ...
        private sealed partial class NetworkChannel : INetworkChannel, IDisposable
        {
            ...
            public IPAddress LocalIPAddress
            {
                get
                {
                    if (m_Socket == null)
                    {
                        throw new System.Exception("You must connect first.");
                    }

                    IPEndPoint ipEndPoint = (IPEndPoint)m_Socket.LocalEndPoint;
                    if (ipEndPoint == null)
                    {
                        throw new System.Exception("Local end point is invalid.");
                    }
            ...
            public IPAddress RemoteIPAddress
            {
                get
                {
                    ...
                    if (ipEndPoint == null)
                    {
                        throw new System.Exception("Remote end point is invalid.");
                    }
            ...
            public void RegisterHandler(IPacketHandler handler)
            {
                if (handler == null)
                {
                    throw new System.Exception("Packet handler is invalid.");
                }
