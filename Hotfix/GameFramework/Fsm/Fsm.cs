...
namespace GameFramework.Fsm
{
    ...
    internal sealed class Fsm<T> : FsmBase, IFsm<T> where T : class
    {
            ...
            : base(name)
        {
            if (owner == null)
            {
                throw new System.Exception("FSM owner is invalid.");
            }

            if (states == null || states.Length < 1)
            {
                throw new System.Exception("FSM states is invalid.");
            }
            ...
            foreach (FsmState<T> state in states)
            {
                ...
                {
                    throw new System.Exception(string.Format("FSM '{0}' state '{1}' is already exist.", Utility.Text.GetFullName<T>(name), stateName));
                }
        ...
        public void Start(Type stateType)
        {
            if (IsRunning)
            {
                throw new System.Exception("FSM is running, can not start again.");
            }

            FsmState<T> state = GetState(stateType);
            if (state == null)
            {
                throw new System.Exception(string.Format("FSM '{0}' can not start state '{1}' which is not exist.", Utility.Text.GetFullName<T>(Name), stateType.FullName));
            }
        ...
        public void FireEvent(object sender, int eventId)
        {
            if (m_CurrentState == null)
            {
                throw new System.Exception("Current state is invalid.");
            }
        ...
        public bool HasData(string name)
        {
            ...
            {
                throw new System.Exception("Data name is invalid.");
            }
        ...
        internal void ChangeState(Type stateType)
        {
            ...
            if (state == null)
            {
                throw new System.Exception(string.Format("FSM '{0}' can not change state to '{1}' which is not exist.", Utility.Text.GetFullName<T>(Name), stateType.FullName));
            }
