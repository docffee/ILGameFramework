...
namespace GameFramework.Scene
{
    ...
    internal sealed class SceneManager : GameFrameworkModule, ISceneManager
    {
        ...
        public void LoadScene(string sceneAssetName, object userData)
        {
            ...
            {
                throw new System.Exception(string.Format("Scene asset '{0}' is being unloaded.", sceneAssetName));
            }

            if (SceneIsLoading(sceneAssetName))
            {
                throw new System.Exception(string.Format("Scene asset '{0}' is being loaded.", sceneAssetName));
            }

            if (SceneIsLoaded(sceneAssetName))
            {
                throw new System.Exception(string.Format("Scene asset '{0}' is already loaded.", sceneAssetName));
            }
        ...
        public void UnloadScene(string sceneAssetName, object userData)
        {
            ...
            if (!SceneIsLoaded(sceneAssetName))
            {
                throw new System.Exception(string.Format("Scene asset '{0}' is not loaded yet.", sceneAssetName));
            }
        ...
        private void UnloadSceneFailureCallback(string sceneAssetName, object userData)
        {
            ...
            throw new System.Exception(string.Format("Unload scene failure, scene asset name '{0}'.", sceneAssetName));
        }
    }
}
