    ...
    internal sealed partial class ResourceManager : GameFrameworkModule, IResourceManager
    {
        ...
        public int UpdateRetryCount
        {
            ...
            set
            {
                ...
                {
                    throw new System.Exception("You can not use UpdateRetryCount at this time.");
                }
        ...
        public void SetReadOnlyPath(string readOnlyPath)
        {
            ...
            {
                throw new System.Exception("Readonly path is invalid.");
            }

            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new System.Exception("You must set readonly path before add load resource agent helper.");
            }
        ...
        public void SetReadWritePath(string readWritePath)
        {
            ...
            {
                throw new System.Exception("Read-write path is invalid.");
            }

            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new System.Exception("You must set read-write path before add load resource agent helper.");
            }
        ...
        public void SetResourceMode(ResourceMode resourceMode)
        {
            ...
            {
                throw new System.Exception("Resource mode is invalid.");
            }
            ...
            {
                throw new System.Exception("You can not change resource mode at this time.");
            }
        }
        ...
        public void SetCurrentVariant(string currentVariant)
        {
            ...
            {
                throw new System.Exception("You can net set current variant at this time.");
            }
        ...
        public void SetObjectPoolManager(IObjectPoolManager objectPoolManager)
        {
            ...
            {
                throw new System.Exception("Object pool manager is invalid.");
            }
        ...
        public void SetDownloadManager(IDownloadManager downloadManager)
        {
            ...
            {
                throw new System.Exception("Download manager is invalid.");
            }
        ...
        public void SetDecryptResourceCallback(DecryptResourceCallback decryptResourceCallback)
        {
            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new System.Exception("You must set decrypt resource callback before add load resource agent helper.");
            }
        ...
        public void SetResourceHelper(IResourceHelper resourceHelper)
        {
            ...
            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new System.Exception("You must set resource helper before add load resource agent helper.");
            }
        ...
        public void InitResources()
        {
            if (m_ResourceMode == ResourceMode.Unspecified)
            {
                throw new System.Exception("You must set resource mode first.");
            }

            if (m_ResourceMode != ResourceMode.Package)
            {
                throw new System.Exception("You can not use InitResources without package resource mode.");
            }

            if (m_ResourceIniter == null)
            {
                throw new System.Exception("You can not use InitResources at this time.");
            }
        ...
        public CheckVersionListResult CheckVersionList(int latestInternalResourceVersion)
        {
            ...
            {
                throw new System.Exception("You can not use InitResources without updatable resource mode.");
            }

            if (m_VersionListProcessor == null)
            {
                throw new System.Exception("You can not use CheckVersionList at this time.");
            }
        ...
        public void UpdateVersionList(int versionListLength, int versionListHashCode, int versionListZipLength, int versionListZipHashCode)
        {
            ...
            if (m_VersionListProcessor == null)
            {
                throw new System.Exception("You can not use UpdateVersionList at this time.");
            }
        ...
        public void CheckResources()
        {
            ...
            if (m_ResourceChecker == null)
            {
                throw new System.Exception("You can not use CheckResources at this time.");
            }
        ...
        public void UpdateResources()
        {
            ...
            if (m_ResourceUpdater == null)
            {
                throw new System.Exception("You can not use UpdateResources at this time.");
            }
        ...
        public void LoadAsset(string assetName, LoadAssetCallbacks loadAssetCallbacks)
        {
            ...
            {
                throw new System.Exception("Asset name is invalid.");
            }

            if (loadAssetCallbacks == null)
            {
                throw new System.Exception("Load asset callbacks is invalid.");
            }
        ...
        public void UnloadAsset(object asset)
        {
            if (asset == null)
            {
                throw new System.Exception("Asset is invalid.");
            }
        ...
        public void LoadScene(string sceneAssetName, LoadSceneCallbacks loadSceneCallbacks)
        {
            ...
            {
                throw new System.Exception("Scene asset name is invalid.");
            }

            if (loadSceneCallbacks == null)
            {
                throw new System.Exception("Load scene callbacks is invalid.");
            }
        ...
        public void UnloadScene(string sceneAssetName, UnloadSceneCallbacks unloadSceneCallbacks)
        {
            ...
            {
                throw new System.Exception("Unload scene callbacks is invalid.");
            }
        ...
        public bool GetResourceGroupReady(string resourceGroupName)
        {
            ...
            {
                throw new System.Exception(string.Format("Can not find resource group '{0}'.", resourceGroupName));
            }
