        ...
        private partial class ResourceChecker
        {
            ...
            private sealed partial class CheckInfo
            {
                ...
                public void SetVersionInfo(LoadType loadType, int length, int hashCode, int zipLength, int zipHashCode)
                {
                    ...
                    {
                        throw new System.Exception(string.Format("You must set version info of '{0}' only once.", m_ResourceName.FullName));
                    }
                ...
                public void SetReadOnlyInfo(LoadType loadType, int length, int hashCode)
                {
                    ...
                    {
                        throw new System.Exception(string.Format("You must set readonly info of '{0}' only once.", m_ResourceName.FullName));
                    }
                ...
                public void SetReadWriteInfo(LoadType loadType, int length, int hashCode)
                {
                    ...
                    {
                        throw new System.Exception(string.Format("You must set read-write info of '{0}' only once.", m_ResourceName.FullName));
                    }
