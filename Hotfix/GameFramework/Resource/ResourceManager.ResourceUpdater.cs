    ...
    internal partial class ResourceManager
    {
        ...
        private sealed partial class ResourceUpdater
        {
            ...
            public void UpdateResources()
            {
                if (m_DownloadManager == null)
                {
                    throw new System.Exception("You must set download manager first.");
                }

                if (!m_CheckResourcesComplete)
                {
                    throw new System.Exception("You must check resources complete first.");
                }
            ...
            private void GenerateReadWriteList()
            {
                ...
                catch (Exception exception)
                {
                    ...
                    throw new System.Exception(string.Format("Pack save exception '{0}'.", exception.Message), exception);
                }
                finally
                {
                    if (fileStream != null)
            ...
            private void OnDownloadSuccess(object sender, DownloadSuccessEventArgs e)
            {
                ...
                {
                    throw new System.Exception(string.Format("Resource info '{0}' is already exist.", updateInfo.ResourceName.FullName));
                }
                ...
                {
                    throw new System.Exception(string.Format("Read-write resource info '{0}' is already exist.", updateInfo.ResourceName.FullName));
                }
            ...
            private void OnDownloadFailure(object sender, DownloadFailureEventArgs e)
            {
                ...
                if (updateInfo.RetryCount < m_RetryCount)
                {
                    ...
                    {
                        throw new System.Exception("Update state error.");
                    }
                }
            }
        }
