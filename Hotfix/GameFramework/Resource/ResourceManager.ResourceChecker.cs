        ...
        private sealed partial class ResourceChecker
        {
            ...
            private void RefreshCheckInfoStatus()
            {
                ...
                foreach (KeyValuePair<ResourceName, CheckInfo> checkInfo in m_CheckInfos)
                {
                    ...
                    {
                        throw new System.Exception(string.Format("Check resources '{0}' error with unknown status.", ci.ResourceName.FullName));
                    }
                    ...
                    if (ci.NeedRemove)
                    {
                        ...
                        {
                            throw new System.Exception(string.Format("Resource '{0}' is not exist in read-write list.", ci.ResourceName.FullName));
                        }
            ...
            private void ParseVersionList(string fileUri, byte[] bytes, string errorMessage)
            {
                ...
                {
                    throw new System.Exception("Version list has been parsed.");
                }

                if (bytes == null || bytes.Length <= 0)
                {
                    throw new System.Exception("Version list is invalid.");
                }
                ...
                try
                {
                    ...
                    using (BinaryReader binaryReader = new BinaryReader(memoryStream))
                    {
                        ...
                        {
                            throw new System.Exception("Version list header is invalid.");
                        }
                        ...
                        if (listVersion == 0)
                        {
                            ...
                            for (int i = 0; i < resourceGroupCount; i++)
                            {
                                ...
                                for (int j = 0; j < groupResourceCount; j++)
                                {
                                    ...
                                    {
                                        throw new System.Exception(string.Format("Version index '{0}' is invalid, resource count is '{1}'.", versionIndex, resourceCount));
                                    }
                        ...
                        {
                            throw new System.Exception("Version list version is invalid.");
                        }
                    }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new System.Exception(string.Format("Parse version list exception '{0}'.", exception.Message), exception);
                }
                finally
                {
            ...
            private void ParseReadOnlyList(string fileUri, byte[] bytes, string errorMessage)
            {
                ...
                {
                    throw new System.Exception("Readonly list has been parsed.");
                }
                ...
                try
                {
                    ...
                    using (BinaryReader binaryReader = new BinaryReader(memoryStream))
                    {
                        ...
                        {
                            throw new System.Exception("Readonly list header is invalid.");
                        }
                        ...
                        {
                            throw new System.Exception("Readonly list version is invalid.");
                        }
                    }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new System.Exception(string.Format("Parse readonly list exception '{0}'.", exception.Message), exception);
                }
                finally
                {
                    if (memoryStream != null)
            ...
            private void ParseReadWriteList(string fileUri, byte[] bytes, string errorMessage)
            {
                ...
                {
                    throw new System.Exception("Read-write list has been parsed.");
                }
                ...
                try
                {
                    ...
                    using (BinaryReader binaryReader = new BinaryReader(memoryStream))
                    {
                        ...
                        {
                            throw new System.Exception("Read-write list header is invalid.");
                        }
                        ...
                        if (listVersion == 0)
                        {
                            ...
                            for (int i = 0; i < resourceCount; i++)
                            {
                                ...
                                {
                                    throw new System.Exception(string.Format("Read-write resource info '{0}' is already exist.", resourceName.FullName));
                                }
                        ...
                        {
                            throw new System.Exception("Read-write list version is invalid.");
                        }
                    }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new System.Exception(string.Format("Parse read-write list exception '{0}'.", exception.Message), exception);
                }
                finally
                {
                    if (memoryStream != null)
            ...
            private void ProcessResourceInfo(ResourceName resourceName, LoadType loadType, int length, int hashCode, bool storageInReadOnly)
            {
                ...
                {
                    throw new System.Exception(string.Format("Resource info '{0}' is already exist.", resourceName.FullName));
                }
