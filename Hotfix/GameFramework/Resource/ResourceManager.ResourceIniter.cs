    ...
    internal partial class ResourceManager
    {
        ...
        private sealed class ResourceIniter
        {
            ...
            private void ParsePackageList(string fileUri, byte[] bytes, string errorMessage)
            {
                ...
                {
                    throw new System.Exception("Package list is invalid.");
                }
                ...
                try
                {
                    ...
                    using (BinaryReader binaryReader = new BinaryReader(memoryStream))
                    {
                        ...
                        {
                            throw new System.Exception("Package list header is invalid.");
                        }
                        ...
                        if (listVersion == 0)
                        {
                            ...
                            for (int i = 0; i < resourceGroupCount; i++)
                            {
                                ...
                                for (int j = 0; j < groupResourceCount; j++)
                                {
                                    ...
                                    {
                                        throw new System.Exception(string.Format("Package index '{0}' is invalid, resource count is '{1}'.", versionIndex, resourceCount));
                                    }
                        ...
                        {
                            throw new System.Exception("Package list version is invalid.");
                        }
                    }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new System.Exception(string.Format("Parse package list exception '{0}'.", exception.Message), exception);
                }
                finally
                {
