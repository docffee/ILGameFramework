...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Boolean_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, TryParse_8);
            args = new Type[]{};
            method = type.GetMethod("GetTypeCode", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetTypeCode_9);

            field = type.GetField("TrueString", flag);
            app.RegisterCLRFieldGetter(field, get_TrueString_0);
            field = type.GetField("FalseString", flag);
            app.RegisterCLRFieldGetter(field, get_FalseString_1);
        ...
        static StackObject* TryParse_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* GetTypeCode_9(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static object get_TrueString_0(ref object o)
        {
            return System.Boolean.TrueString;
        }
        static object get_FalseString_1(ref object o)
        {
